const firstInput = document.getElementById('first-input') as HTMLInputElement | null
const secondInput = document.getElementById('second-input') as HTMLInputElement | null
...
function compasso(firstInputValue: number, secondInputValue: number) {
    if (!res) return
